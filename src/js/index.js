...
jQuery(document).ready(function() {
    ...
    $(".openPhotoModal").click(function(){
		var srcImg = $(this).data("whatever");
        $("#photoWorkModal img").attr("src",srcImg);
        $("#photoWorkModal").modal("show");
    })
 

// $('#photoWorkModal').on('show.bs.modal', function (event) {
...
// 	modal.find('.modal-body img').setAttribute('src',recipient)
//   })
